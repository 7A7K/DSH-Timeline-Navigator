window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    .tlnav-panel {
      position: fixed; top: var(--tlnav-top, 0); right: 0; bottom: 0; width: 240px;
      min-width: 180px; max-width: 420px; z-index: 50; display: flex;
    ...
    .tlnav-header { display: flex; align-items: center; gap: 4px; padding: 10px 10px 8px 14px; border-bottom: 1px solid var(--dsw-alias-border-l2); flex: none; }
    .tlnav-title { flex: 1; min-width: 0; font: var(--dsw-font-s-strong-14); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    .tlnav-search-row { display: flex; align-items: center; border-bottom: 1px solid var(--dsw-alias-border-l2); background: var(--dsw-alias-bg-layer-1); }
    .tlnav-search { box-sizing: border-box; width: 100%; margin: 0; padding: 9px 8px 9px 14px; background: transparent; border: none; color: var(--dsw-alias-label-primary); font: var(--dsw-font-xs-13); outline: none; }
    .tlnav-search::placeholder { color: var(--dsw-alias-label-caption); }
    .tlnav-clear { margin-right: 8px; padding: 3px 6px; font-size: 14px; }
    ...
    function useLanguage(locale) {
      const [language, setLanguage] = import_react.default.useState(() => readLanguage(locale));
      import_react.default.useEffect(() => {
    ...
    function SettingsCard(props) {
      ...
      return import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement("div", { className: "tlnav-card-title" }, props.t("timeline.title")),
          import_react.default.createElement("div", { className: "tlnav-card-desc" }, props.t("timeline.description"))
        ),
        import_react.default.createElement(
          "button",
          {
      ...
      return import_react.default.createElement(
        ...
        import_react.default.createElement(
          "button",
          {
            ...
            type: "button",
            "aria-label": `${nav.turn != null ? `${t("turnLabel")} ${nav.turn} \xB7 ` : ""}${nav.title}`,
          ...
          import_react.default.createElement("span", { className: "tlnav-label" }, nav.title)
        ),
        import_react.default.createElement(
          "button",
          {
    ...
    function PreviewCard({ preview, t }) {
      ...
      return import_react.default.createElement(
        ...
        import_react.default.createElement("div", { className: "tlnav-preview-title" }, preview.nav.title),
        preview.nav.preview ? import_react.default.createElement("div", { className: "tlnav-preview-text" }, preview.nav.preview) : null,
        preview.nav.turn != null ? import_react.default.createElement("div", { className: "tlnav-preview-meta" }, `${t("turnLabel")} ${preview.nav.turn}${preview.nav.step != null ? ` \xB7 step ${preview.nav.step}` : ""}`) : null
      );
    }
    ...
    function RailPanel({ sessions, locale, useSessions }) {
      ...
      const store = import_react.default.useMemo(() => createAppStore(storage), [storage]);
      ...
      const [search, setSearch] = import_react.default.useState("");
      ...
      const visiblePoints = import_react.default.useMemo(() => filterNavPoints(navPoints, mode, search), [navPoints, mode, search]);
      ...
      const listContent = navPoints.length === 0 ? import_react.default.createElement("div", { className: "tlnav-empty" }, t("empty")) : visiblePoints.length === 0 ? import_react.default.createElement("div", { className: "tlnav-empty" }, search.trim() ? t("noSearch") : t("noNodes")) : rows;
      return import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(
            ...
            import_react.default.createElement("span", { className: "tlnav-title" }, t("title")),
            running ? import_react.default.createElement("span", { className: "tlnav-running", title: t("running"), "aria-label": t("running") }) : null,
            import_react.default.createElement("button", { type: "button", className: "tlnav-btn", "aria-pressed": pinned, onClick: () => setPinned((value) => !value), title: t("pin"), "aria-label": t("pin"), "data-tooltip": t("pin") }, "\u{1F4CC}"),
            import_react.default.createElement("button", { type: "button", className: "tlnav-btn", "aria-pressed": mode === "all", onClick: () => store.toggleFilterMode(), title: mode === "messages" ? t("showAll") : t("showMessages"), "aria-label": mode === "messages" ? t("showAll") : t("showMessages"), "data-tooltip": mode === "messages" ? t("showAll") : t("showMessages") }, mode === "messages" ? t("messages") : t("all")),
            import_react.default.createElement("button", { type: "button", className: "tlnav-btn", "aria-pressed": smooth, onClick: () => store.toggleSmooth(), title: smooth ? t("smooth") : t("jump"), "aria-label": smooth ? t("smooth") : t("jump"), "data-tooltip": smooth ? t("smooth") : t("jump") }, smooth ? "\u219D" : "\u21A3"),
            import_react.default.createElement("button", { type: "button", className: "tlnav-btn", onClick: jumpToEarliest, title: t("earliest"), "aria-label": t("earliest"), "data-tooltip": t("earliest"), "data-action": "jump-earliest" }, "\u2191"),
            import_react.default.createElement("button", { type: "button", className: "tlnav-btn", onClick: jumpToLatest, title: t("latest"), "aria-label": t("latest"), "data-tooltip": t("latest"), "data-action": "jump-latest" }, "\u2193")
          ),
          import_react.default.createElement(
            "div",
            { className: "tlnav-search-row" },
            import_react.default.createElement("input", { className: "tlnav-search", type: "search", placeholder: t("search"), "aria-label": t("search"), value: search, onChange: (event) => setSearch(event.target.value) }),
            search ? import_react.default.createElement("button", { type: "button", className: "tlnav-btn tlnav-clear", onClick: () => setSearch(""), title: t("clearSearch"), "aria-label": t("clearSearch") }, "\xD7") : null
          ),
    ...
    function apply(ctx) {
      ...
      slots.inject("shell.overlay", () => slots.register(
        ...
        (props) => import_react.default.createElement(RailPanel, { sessions, locale, useSessions: props.useSessions })
      ));
