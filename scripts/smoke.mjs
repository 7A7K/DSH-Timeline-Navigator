...
try {
  ...
  if (await panel.locator('.tlnav-search, .tlnav-turn-jump').count() !== 0 || await panel.locator('.tlnav-spacer').count() !== 1) {
    throw new Error('The retired control rows were not removed cleanly.')
  }
